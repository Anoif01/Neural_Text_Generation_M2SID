...
def preprocess_input_files(data_dir, dataset):
    ...
    in_sent = os.path.join(data_dir, './data/',dataset, '%s.sent' % (dataset))
    out_sent = os.path.join(data_dir, './data/',dataset, '%s_in.sent' % (dataset))
    nb_file = os.path.join(data_dir, './data/',dataset, '%s.nb' % (dataset))
...
def create_dataset(data_dir, dataset, n, batch_size):
    ...
    in_sent = os.path.join(data_dir, 'data/',dataset, '%s_in.sent' % (dataset))
    ...
    x_path = os.path.join(data_dir, 'data/',dataset, '%s_x' % (dataset))
    y_path = os.path.join(data_dir, 'data/',dataset, '%s_y' % (dataset))
...
def setup(data_dir, embed_dir, n, batch_size, nW, min_field_freq, nQ):
    ...
    """
    preprocess_input_files('/content/drive/MyDrive/GM5/DEEP/Paper/NeuralTextGeneration-master/data/', 'train')
    preprocess_input_files('/content/drive/MyDrive/GM5/DEEP/Paper/NeuralTextGeneration-master/data/', 'test')
    preprocess_input_files('/content/drive/MyDrive/GM5/DEEP/Paper/NeuralTextGeneration-master/data/', 'valid')
